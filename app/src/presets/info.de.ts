// German preset explanations. Keyed by the @biosim/core preset name (stable id).
...
export const PRESET_INFO_DE: Record<string, PresetInfo> = {
  'Aktionspotential': {
  ...
  'Xolotl: Half-Center-Oszillator': {
    name: 'Xolotl: Half-Center-Oszillator',
    summary:
