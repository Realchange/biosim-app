...
export const de: Messages = {
  ...
  params: {
    ...
    savedInfoBtnTitle: 'Erklärung: Zustände speichern & weitergeben',
    savedInfoTitle: 'Zustände speichern & weitergeben',
    savedInfoIntro: 'Ein gespeicherter Zustand ist eine Momentaufnahme aller aktuellen Einstellungen — Neuronen-Parameter, Stromstimulation und Synapsenstärken — unter einem Namen. So kannst du eine bestimmte Simulation jederzeit exakt wiederherstellen.',
    savedInfoLocalLabel: 'Lokal speichern (dieser Browser)',
    savedInfoLocalBody: 'Mit „+ Aktuellen Zustand speichern" bleibt der Zustand in diesem Browser und erscheint in der Liste — auch nach dem Neuladen. Er liegt aber nur auf diesem Gerät bzw. in diesem Browser und wird nicht automatisch weitergegeben.',
    savedInfoFileLabel: 'Als Datei speichern (weitergeben)',
    savedInfoFileBody: 'Mit ⬇ exportierst du einen Zustand als .biosim.json-Datei. Diese Datei kannst du an andere weitergeben (z. B. an Studierende oder Kolleg:innen) oder auf ein anderes Gerät kopieren. Empfänger holen sie mit ⬆ „Datei importieren" in ihre eigene Liste.',
    savedInfoBundledLabel: 'Mitgelieferte Beispiele (🔒)',
    savedInfoBundledBody: 'Zustände mit einem Schloss sind fest mitgeliefert (z. B. der kollabierte Rhythmus). Sie sind sofort da und lassen sich nicht ändern oder löschen — nur laden.',
    savedInfoClose: 'Schließen',
  },
